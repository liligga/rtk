...
use cmds::python::{mypy_cmd, pip_cmd, py_compile_cmd, pytest_cmd, ruff_cmd};
...
enum Commands {
    ...
    /// Python py_compile with compact error output
    PyCompile {
        /// Python files passed to py_compile
        #[arg(trailing_var_arg = true, allow_hyphen_values = true)]
        args: Vec<String>,
    },
...
fn run_cli() -> Result<i32> {
    ...
    let code = match cli.command {
        ...
        Commands::PyCompile { args } => py_compile_cmd::run(&args, cli.verbose)?,
